...
func TestClaudeInstallSkipsCurrentSettingsWithoutReformatting(t *testing.T) {
  ...
  "hooks": {
    "Notification": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh blocked", "type": "command"}]}],
    "SessionEnd": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh stopped", "type": "command"}]}],
    "PreToolUse": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh tool_start", "type": "command"}]}],
    "SubagentStop": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh subagent_stop", "type": "command"}]}],
    "SessionStart": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh starting", "type": "command"}]}],
    "Stop": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh done", "type": "command"}]}],
    "PostToolUse": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh tool_end", "type": "command"}]}],
    "UserPromptSubmit": [{"hooks": [{"timeout": 5, "command": "~/.claude/hooks/party-cli-state.sh working", "type": "command"}]}]
  },
