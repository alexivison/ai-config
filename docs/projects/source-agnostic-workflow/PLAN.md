...
> **Goal:** Make the execution pipeline (task-workflow, scribe, execution-core) work regardless of where work was planned — TASK files, OpenSpec, or any other planning source — without touching external tool configs.
>
...
- [ ] [Task 2](./tasks/TASK2-format-blind-scribe.md) — Make scribe receive requirements as text instead of reading planning files (deps: Task 1)
...
- [ ] scribe receives requirements and scope as text in its prompt
