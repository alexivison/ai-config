...
- [x] [Task 3](./tasks/TASK3-restyle-master-tracker-manifest-and-composer.md) — Apply the new chrome to the master tracker, manifest viewer, and relay/broadcast/spawn composer, including reverse-row selection, readable inactive titles, ANSI-aware selection tests, and compact height fallback rules (deps: Task 1)
