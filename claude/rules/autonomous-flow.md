...
| Implementing every wizard finding without triage | Classify as blocking/non-blocking/out-of-scope first |
| Re-running full cascade after one-line wizard fix | Use tiered re-review (test-runner only for targeted swaps) |
