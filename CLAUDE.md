...
- **Advisory agents** (architecture-critic): On REQUEST_CHANGES, ask user if they want to create a follow-up refactor task, then proceed. PR is not blocked. Only ask user if NEEDS_DISCUSSION.
